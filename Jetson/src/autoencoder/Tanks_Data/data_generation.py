...
if __name__ == '__main__': 
    ...
    if noise_inputs:
        ...
        torch.save(data_clean, 'No_Noised_Inputs/data_clean_lin.pkl')
        torch.save(data_white_noise, 'No_Noised_Inputs/data_white_noise.pkl')
        torch.save(data_pink_noise, 'No_Noised_Inputs/data_pink_noise.pkl')
        torch.save(data_brown_noise, 'No_Noised_Inputs/data_brown_noise.pkl')
        torch.save(data_all_noises, 'No_Noised_Inputs/data_all_noises.pkl')
        torch.save(data_salt_and_pepper, 'No_Noised_Inputs/data_saltPepper_noises.pkl')
